...
-- ---------- عملیات مدیریتی امن ----------
CREATE OR REPLACE FUNCTION public.admin_set_traveler_status(target_user uuid, new_status public.verification_status)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path=public
...
END;
$$;
REVOKE ALL ON FUNCTION public.admin_set_traveler_status(uuid,public.verification_status) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.admin_set_traveler_status(uuid,public.verification_status) TO authenticated;
